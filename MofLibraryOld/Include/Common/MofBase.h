...
#define		MOF_CLASSID(id)							virtual const MofU32 GetTypeID(void) const { return (MofU32)id; } static const MofU32 GetClassID(void){ return (MofU32)id; }
...
#define		MOF_LIBRARYCLASS_NOTCOPY(s,id)			MOF_CLASSNAME(MOF_VALUENAME(s)) MOF_CLASSID(id) private: s(const s& pObj) = delete;
