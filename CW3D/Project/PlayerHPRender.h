...
namespace Sample
{
	...
	public:
		...
		void Load()
		{
			m_pHPBar = Sample::ResourceManager<CTexture>::GetInstance().GetResource("PlayerHPBar");
			m_pFrame = Sample::ResourceManager<CTexture>::GetInstance().GetResource("PlayerHPFrame");
			m_pDamageBar = Sample::ResourceManager<CTexture>::GetInstance().GetResource("PlayerHPBar");
