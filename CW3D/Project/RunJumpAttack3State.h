...
namespace Sample {
	...
	private:
		...
		ShotAABB createShotStatus = { Vector3(0.7f, 0.7f, 0), 0.5f, 0, Vector3(0.3f, 0.2f, 0.0f),true,0, nullptr, Vector3(1.5f, 1.5f, 1.5f) };
	public:
		/**
		 * @brief		コンストラクタ
		 */
		...
		void Execution() override {
			for (auto& shot : m_pShots)
			{
				...
				else if (m_CurrentTime >= CollideEndFrameTime && shot->GetCollideFlg())
				{
