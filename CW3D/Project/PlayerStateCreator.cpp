...
bool ActionGame::PlayerStateCreator::Create(const StateMachinePtr& stateMachine, const ActorPtr& actor, const InputPtr& input)
{
	...
	stateMachine->AddState(State::Create<Attack1State>(actor, input,
		Attack1State::Parameter{
			...
			,GameFrameTime * 25.0f
			,GameFrameTime * 42.0f
			,ShotAABB{ Vector3(0.7f, 0.7f, 0), 1.5f, 0, Vector3(0.3f, 0.0f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr ,2,1.0f,0,Vector3(1.2f, 1.5f, 1.0f) }
	...
	stateMachine->AddState(State::Create<Attack2State>(actor, input,
		Attack2State::Parameter{
			...
			,GameFrameTime * 20.0f
			,GameFrameTime * 35.0f
			,ShotAABB{ Vector3(0.7f, 0.7f, 0), 1.0f, 0, Vector3(0.2f, 0.0f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,2,1.0f,0, Vector3(1.2f, 1.5f, 1.0f) }
	...
	stateMachine->AddState(State::Create<Attack3State>(actor, input,
		Attack3State::Parameter{
			...
			,GameFrameTime * 15.0f
			,GameFrameTime * 45.0f
			,ShotAABB{ Vector3(0.7f, 0.7f, 0), 0.3f, 0, Vector3(0.3f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,2,1.5f,0, Vector3(1.2f, 2.0f, 1.0f)}
	...
	stateMachine->AddState(State::Create<RunAttack1State>(actor, input,
		RunAttack1State::Parameter{
			...
			,GameFrameTime * 20.0f
			,GameFrameTime * 40.0f
			,ShotAABB{ Vector3(0.7f, 0.8f, 0), 0.5f, 0, Vector3(0.4f, 0.0f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,2,1.5f,0, Vector3(1.2f, 1.5f, 0.8f) }
	...
	stateMachine->AddState(State::Create<JumpAttack1State>(actor, input,
		JumpAttack1State::Parameter{
			2
			,GameFrameTime * 20.0f
			,ShotAABB{ Vector3(0.7f, 0.8f, 0), 10.0f, 0, Vector3(0.1f, 0.25f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,2,1.0f,0, Vector3(1.0f, 1.2f, 1.0f) }
	...
	stateMachine->AddState(State::Create<RunJumpAttack1State>(actor, input,
		RunJumpAttack1State::Parameter{
			...
			,GameFrameTime * 15.0f
			,GameFrameTime * 22.0f
			,ShotAABB{ Vector3(0.8f, 0.7f, 0), 10.0f, 0, Vector3(0.35f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,2,1.0f,0, Vector3(1.5f, 1.5f, 1.5f) }
			,EffectCreateParameter{ "Effect2", Vector3(0.8f,0.8f,0), Vector3(0.5f, 0.8f, 0.0f), Vector3(0.0f, MOF_ToRadian(360), 0.0f),1.5f }
	...
	stateMachine->AddState(State::Create<RunJumpAttack2State>(actor, input,
		RunJumpAttack2State::Parameter{
			2
			,GameFrameTime * 20.0f
			,ShotAABB{ Vector3(0.7f, 0.7f, 0), 10.0f, 0, Vector3(0.35f, 0.2f, 0.0f),true,CHARA_TYPE::PLAYER, nullptr,2,1.0f,0, Vector3(1.5f, 1.5f, 1.5f) }
	...
	stateMachine->AddState(State::Create<RunJumpAttack3State>(actor, input,
		RunJumpAttack3State::Parameter{
			...
			,GameFrameTime * 12.0f
			,GameFrameTime * 40.0f
			,ShotAABB{ Vector3(0.7f, 1.2f, 0), 0.3f, 0, Vector3(0.45f, 0.2f, 0.0f),true,CHARA_TYPE::PLAYER, nullptr,2,1.5f,0, Vector3(1.5f, 2.0f, 1.5f) }
	...
	stateMachine->AddState(State::Create<ShockWaveSkillState>(actor, input,
		ShockWaveSkillState::Parameter{
			...
			,GameFrameTime * 40.0f
			,GameFrameTime * 80.0f
			,ShotAABB{ Vector3(5.0f, 0.7f, 0), 0.05f, 0, Vector3(0.5f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,4,0.3f,0, Vector3(7.0f, 10.0f, 7.0f) }
	...
	stateMachine->AddState(State::Create<BeamSkillState>(actor, input,
		BeamSkillState::Parameter{
			...
			,GameFrameTime * 15.0f
			,GameFrameTime * 25.0f
			,ShotAABB{ Vector3(6.0f, 0.7f, 0), 0.0f, 0, Vector3(0.05f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,3,0.75f,0, Vector3(5.0f, 2.0f, 2.0f) }
			,ShotOBB{ Vector3(1.0f, 2.0f, 0), 0.0f, 0, Vector3(0.05f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,3,0.75f,0, Vector3(5.0f, 2.0f, 2.0f), Vector3(0, 0, MOF_ToRadian(30))}
	...
	stateMachine->AddState(State::Create<JumpBeamSkillState>(actor, input,
		JumpBeamSkillState::Parameter{
			...
			,GameFrameTime * 25.0f
			,ShotAABB{ Vector3(6.0f, 0.7f, 0), 0.0f, 0, Vector3(0.05f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,3,0.75f,0, Vector3(5.0f, 2.0f, 2.0f) }
			,ShotOBB{ Vector3(2.0f, 1.4f, 0), 0.0f, 0, Vector3(0.05f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,3,0.75f,0, Vector3(5.0f, 2.0f, 2.0f),Vector3(0, 0, MOF_ToRadian(-30)) }
			,EffectCreateParameter{ "Effect4", Vector3(1.7f, 1.2f, 0), Vector3(1.0f, 1.0f, 1.0f), Vector3(0.0f, MOF_ToRadian(90), 0.0f),1.2f }
	...
	stateMachine->AddState(State::Create<StormSkillState>(actor, input,
		StormSkillState::Parameter{
			...
			,GameFrameTime * 7.0f
			,3.5f
			,ShotAABB{ Vector3(0.0f, 0.0f, 0), 0.25f, 0, Vector3(0.6f, 0.15f, 0.6f),false,CHARA_TYPE::PLAYER, nullptr,3,0.5f,0, Vector3(4.0f, 8.0f, 4.0f) }
	...
	stateMachine->AddState(State::Create<DropKickSkillState>(actor, input,
		DropKickSkillState::Parameter{
			...
			,GameFrameTime * 5.0f
			,GameFrameTime * 30.0f
			,ShotAABB{ Vector3(1.0f, 0.7f, 0), 2.0f, 0, Vector3(0.7f, 0.32f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,4,3.5f,0, Vector3(4.0f, 3.0f, 3.0f) }
