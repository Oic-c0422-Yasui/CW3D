...
bool ActionGame::PlayerStateCreator::Create(const StateMachinePtr& stateMachine, const ActorPtr& actor, const Input::InputPtr& input)
{
	...
	stateMachine->AddState(CState::Create<CAttack1State>(actor, input,
		CAttack1State::Parameter{
			...
			,GameFrameTime * 25.0f
			,GameFrameTime * 42.0f
			,ShotAABB{ Vector3(0.7f, 0.7f, 0), 1.5f, 0, Vector3(0.3f, 0.0f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr ,2,1.0f,0,damageEffect,Vector3(1.2f, 1.5f, 1.0f) }
	...
	stateMachine->AddState(CState::Create<CJumpAttack1State>(actor, input,
		CJumpAttack1State::Parameter{
			2
			,GameFrameTime * 20.0f
			,ShotAABB{ Vector3(0.7f, 0.8f, 0), 10.0f, 0, Vector3(0.1f, 0.25f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,2,1.0f,0,damageEffect, Vector3(1.0f, 1.2f, 1.0f) }
	...
	stateMachine->AddState(CState::Create<CRunJumpAttack1State>(actor, input,
		CRunJumpAttack1State::Parameter{
			...
			,GameFrameTime * 15.0f
			,GameFrameTime * 22.0f
			,ShotAABB{ Vector3(0.8f, 0.7f, 0), 10.0f, 0, Vector3(0.35f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,2,1.0f,0,damageEffect, Vector3(1.5f, 1.5f, 1.5f) }
			,EffectCreateParameter{ "AttackEffect2", Vector3(0.8f,0.8f,0), Vector3(0.5f, 0.8f, 0.0f), Vector3(0.0f, MOF_ToRadian(360), 0.0f),1.5f }
	...
	stateMachine->AddState(CState::Create<CRunJumpAttack2State>(actor, input,
		CRunJumpAttack2State::Parameter{
			2
			,GameFrameTime * 20.0f
			,ShotAABB{ Vector3(0.7f, 0.7f, 0), 10.0f, 0, Vector3(0.35f, 0.2f, 0.0f),true,CHARA_TYPE::PLAYER, nullptr,2,1.0f,0,damageEffect, Vector3(1.5f, 1.5f, 1.5f) }
	...
	stateMachine->AddState(CState::Create<CRunJumpAttack3State>(actor, input,
		CRunJumpAttack3State::Parameter{
			...
			,GameFrameTime * 12.0f
			,GameFrameTime * 40.0f
			,ShotAABB{ Vector3(0.7f, 1.2f, 0), 0.3f, 0, Vector3(0.45f, 0.2f, 0.0f),true,CHARA_TYPE::PLAYER, nullptr,2,1.5f,0,damageEffect, Vector3(1.5f, 2.0f, 1.5f) }
	...
	stateMachine->AddState(CState::Create<CShockWaveSkillState>(actor, input,
		CShockWaveSkillState::Parameter{
			...
			,GameFrameTime * 40.0f
			,GameFrameTime * 80.0f
			,ShotAABB{ Vector3(5.0f, 0.7f, 0), 0.05f, 0, Vector3(0.5f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,4,0.3f,0,nullptr, Vector3(7.0f, 10.0f, 7.0f) }
	...
	stateMachine->AddState(CState::Create<CBeamSkillState>(actor, input,
		CBeamSkillState::Parameter{
			...
			,GameFrameTime * 15.0f
			,GameFrameTime * 25.0f
			,ShotAABB{ Vector3(6.0f, 0.7f, 0), 0.0f, 0, Vector3(0.05f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,3,0.75f,0,damageEffect, Vector3(5.0f, 2.0f, 2.0f) }
			,ShotOBB{ Vector3(1.0f, 2.0f, 0), 0.0f, 0, Vector3(0.05f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,3,0.75f,0,damageEffect, Vector3(5.0f, 2.0f, 2.0f), Vector3(0, 0, MOF_ToRadian(30))}
	...
	stateMachine->AddState(CState::Create<CJumpBeamSkillState>(actor, input,
		CJumpBeamSkillState::Parameter{
			...
			,GameFrameTime * 25.0f
			,ShotAABB{ Vector3(6.0f, 0.7f, 0), 0.0f, 0, Vector3(0.05f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,3,0.75f,0,damageEffect, Vector3(5.0f, 2.0f, 2.0f) }
			,ShotOBB{ Vector3(2.0f, 1.4f, 0), 0.0f, 0, Vector3(0.05f, 0.2f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,3,0.75f,0,damageEffect, Vector3(5.0f, 2.0f, 2.0f),Vector3(0, 0, MOF_ToRadian(-30)) }
			,EffectCreateParameter{ "SkillEffect2", Vector3(1.7f, 1.2f, 0), Vector3(1.0f, 1.0f, 1.0f), Vector3(0.0f, MOF_ToRadian(90), 0.0f),1.2f }
	...
	stateMachine->AddState(CState::Create<CStormSkillState>(actor, input,
		CStormSkillState::Parameter{
			...
			,GameFrameTime * 7.0f
			,3.5f
			,ShotAABB{ Vector3(0.0f, 0.0f, 0), 0.25f, 0, Vector3(0.6f, 0.15f, 0.6f),false,CHARA_TYPE::PLAYER, nullptr,3,0.5f,0,damageEffect, Vector3(4.0f, 8.0f, 4.0f) }
	...
	stateMachine->AddState(CState::Create<CDropKickSkillState>(actor, input,
		CDropKickSkillState::Parameter{
			...
			,GameFrameTime * 5.0f
			,GameFrameTime * 30.0f
			,ShotAABB{ Vector3(1.0f, 0.7f, 0), 2.0f, 0, Vector3(0.7f, 0.32f, 0.0f),false,CHARA_TYPE::PLAYER, nullptr,4,3.5f,0,damageEffect, Vector3(4.0f, 3.0f, 3.0f) }
