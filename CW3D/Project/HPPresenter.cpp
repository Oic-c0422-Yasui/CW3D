...
void ActionGame::CHPPresenter::Present(const EnemyPtr& enemy, const ActionGame::NormalEnemyHPRenderPtr& view)
...
void ActionGame::CHPPresenter::Present(const EnemyPtr& enemy, const ActionGame::BossHPRenderPtr& view)
{
	enemy->GetHPSubject()->Subscribe([view](int hp) { view->SetHP(hp); });
	enemy->GetMaxHPSubject()->Subscribe([view](int hp) { view->SetMaxHP(hp); });
	enemy->GetShowSubject().Subscribe([view](bool show) { view->SetShow(show); });
...
void ActionGame::CHPPresenter::Present(const PlayerPtr& player, const ActionGame::PlayerHPRenderPtr& view)
{
