...
void Sample::EffectRenderer::Initialize()
{
	// 管理モジュールの設定
...
Effekseer::Handle Sample::EffectRenderer::Play(const std::string& key)
...
void Sample::EffectRenderer::Update()
{
...
void Sample::EffectRenderer::Render()
{
	//カメラコントローラーから座標を取得
