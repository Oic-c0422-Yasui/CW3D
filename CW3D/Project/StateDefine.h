...
//ファイアフレイムスキルステート
constexpr char* STATE_KEY_FIREFLAME_SKILL = "FireFlameSkill";
//チェイススキルステート
constexpr char* STATE_KEY_CHASE_SKILL = "ChaseAttack";
//吸引スキルステート
constexpr char* STATE_KEY_INHALE_SKILL = "Inhale";
//叩きつけスキルステート
constexpr char* STATE_KEY_IMPACT_SKILL = "Impact";
//回避ステート
