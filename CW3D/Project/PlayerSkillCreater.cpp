...
bool ActionGame::PlayerSkillCreator::Create(const ActorPtr& actor)
{
	...
	UltimateSkillDataPtr ultData = std::make_shared<UltimateSkillData>(550, 20, 75.0f);
	...
	AdditionalSkillDataPtr addData = std::make_shared<AdditionalSkillData>(1200, 8, 3.5f, GameFrameTime * 30.0f, 0);
