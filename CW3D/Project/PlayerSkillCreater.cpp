...
bool ActionGame::PlayerSkillCreator::Create(const ActorPtr& actor)
{
	...
	skill = actor->GetSkillController()->Create(SKILL_KEY_5, INPUT_KEY_SKILL5, "Skill1", STATE_KEY_FLYHIGH_SKILL, STATE_KEY_FLYHIGH_SKILL);
	skill->SetSkillData(700, 6);
	skill = actor->GetSkillController()->Create(SKILL_KEY_6, INPUT_KEY_SKILL6, "Skill2", STATE_KEY_IMPACT_SKILL, STATE_KEY_IMPACT_SKILL);
	...
	skill = actor->GetSkillController()->Create(SKILL_KEY_8, INPUT_KEY_SKILL8, "Skill4", STATE_KEY_FIREFLAME_SKILL, STATE_KEY_FIREFLAME_SKILL, ult);
	...
	skill = actor->GetSkillController()->Create(SKILL_KEY_7, INPUT_KEY_SKILL7, "Skill3", STATE_KEY_CHASE_SKILL, STATE_KEY_CHASE_SKILL, addSkill);
