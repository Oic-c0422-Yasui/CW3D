...
{
	class CFlyHighSkillState :	public CAttackBaseState
	{
	public:
		/*
		* @brief	ステートパラメータ
		...
		* @param	EscapeStartTime 　	　	当たり判定終了時間
		* @param	EscapeTime 　		　	当たり判定終了時間
	...
	protected:
		virtual const KnockBackPtr GetKnockBack() { return std::make_shared<CInhaleKnockBack>(Actor()); }
	...
	public:
		 ...
		 * @brief		コンストラクタ
		 */
		CFlyHighSkillState(Parameter param);
