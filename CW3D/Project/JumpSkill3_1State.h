...
namespace Sample {
	 ...
	 * @brief		移動ステート
	 */
	class JumpSkill3_1State : public State
	{
	private:
		/** 移動アクション */
	...
	public:
		...
		void Start() override {
			...
			m_Shots.push_back(ShotManagerInstance.Create(Actor()->GetPosition(), Vector3(0, 0, 0), Vector3(4.0f, 10.0f, 4.0f),0.1f, attack, 0));
