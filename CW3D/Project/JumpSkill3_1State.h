...
namespace Sample {
	...
	private:
		...
		const ShotAABB createShotStatusAABB = { Vector3(0.0f, 0.0f, 0), 0.1f, 0, Vector3(-0.1f, 0.1f, 0.0f),false,0, std::make_shared<CFixedKnockBack>(Actor()), Vector3(4.0f, 8.0f, 4.0f) };
