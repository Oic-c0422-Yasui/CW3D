...
namespace MyUtilities
{
	...
	//補間アニメーション
	static float InterpolationAnim(float animTime, const ANIM_DATA_ARRAY& animData)
	{
		int phase;
	...
	//補間アニメーション
	static Vector3 InterpolationAnim(float animTime, ANIM_V3_DATA* animData, int count)
	{
		int phase;
		for (phase = 1; phase < count; phase++)
		{
	...
	//補間アニメーション
	static Vector3 InterpolationAnim(float animTime,const ANIM_V3_DATA_ARRAY& animData)
	{
		int phase;
		int count = animData.size();
		for (phase = 1; phase < count; phase++)
